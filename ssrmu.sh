...
Install_Libsodium(){
	...
	if [[ ${release} == "centos" ]]; then
		...
		echo -e "${Info} 下载..."
		wget  --no-check-certificate -N "https://github.com/875706361/875706361/blob/master/libsodium-1.0.18..tar.gz"
		echo -e "${Info} 解压..."
		tar -xzf libsodium-1.0.18..tar.gz && cd libsodium-1.0.18..tar.gz
		echo -e "${Info} 编译安装..."
