...
install_v2-ui() {
    ...
    wget -N --no-check-certificate -O /usr/local/v2-ui-linux.tar.gz https://github.com/875706361/875706361/raw/master/v2-ui-master/v2-ui-master.zip
    if [[ $? -ne 0 ]]; then
    ...
    curl -o /usr/bin/v2-ui -Ls https://raw.githubusercontent.com/875706361/875706361/master/v2-ui-master/v2-ui.sh
